...
//   const { imageFullData, setImageFullData, images, imageProcessor, getLinks, imageError, setMoreThan1, moreThan1 } =
//     useImageData(setLoading, setFinished, setResult);
...
//       getLinks(images[0]!.blob); // getLinks(images[selectedImage]!.blob);
//       setLoading(true);
//     };
