...
function InputLoginButton({ icon, type, pholder, mlength, name }: InputLoginButtonProps) {
  ...
  return (
    <div className="group flex items-center justify-start">
      ...
      <input
        className="disabled mb-[12px] h-[52px] w-[310px] appearance-none select-none rounded-[1.25rem] border-2 border-[#E8E8E8] bg-[#FBF9FA] pl-11 text-[20px] text-black shadow-md placeholder:text-[#C4C4C4] invalid:border-[#FF8383] invalid:text-[#FF8383] focus:border-[2.5px] focus:outline-none focus:placeholder:text-transparent invalid:focus:text-[#FF8383] empty:border-[#E8E8E8]"
        type={type}
        placeholder={pholder}
        required
        minLength={mlength}
