...
function PWReqs({toggleReqs} : PWReqsProps) {
  return (
    <div className="absolute flex flex-col mt-[44px] z-10">
      ...
      <div className="flex h-[86px] w-[310px] items-center justify-between rounded-xl bg-[#FBF9FA] px-[11px] py-[2px] text-[14px] leading-none text-black shadow-xl dark:bg-[#293433] dark:text-[#FBF9FA]">
